...
import AIExpenseAdvisor from '../components/AIExpenseAdvisor';
  ...
  useEffect(() => {
    const fetchAnalytics = async () => {
      try {
        ...
        // Fetch user groups
        const groupsRes = await fetch(`${baseURL}/group-memberships/user/${userId}`, {
          method: 'GET',
          headers: { 
        ...
        const groups = Array.isArray(groupsData) ? groupsData : [groupsData];
        ...
        // Store all expenses for AI Advisor (NEW FEATURE)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {/* NEW FEATURE: AI Expense Advisor - Uses Expense Insights API */}
        <div className="mb-8">
          <AIExpenseAdvisor expenses={allExpenses} />
        </div>
